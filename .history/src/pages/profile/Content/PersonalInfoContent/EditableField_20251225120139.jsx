...
export default function EditableField({label,initialValue,isPassword = false,onSave}) {
 ...
 useEffect(()=>{
  ...
  const CurrentPassowrd=currentPassword
  const NewPasword 
        ...
        {isEditing ? (
          ...
          <>
            {isPassword ? (
              ...
              <span className="profilPage-info-value">{showPassword?(currentPassword?currentPassword:newPassword):maskedPassword}</span>
            ) : (
