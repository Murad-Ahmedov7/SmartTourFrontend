...
export default function LoginForm() {
  ...
  const onSubmit =  async (data) => {
   try {
     ...
     localStorage.setItem("result",res.data.token);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="form-options">
        ...
        <Link to='/auth/login/forgot-password' className="forgot-password">
          Forgot password?
        </Link>
      </div>
      ...
      <div className="social-login">
        <Link to='https://localhost:7293/api/auth/google-login' type="button" className="social-btn google">
          G Google
        </button>
