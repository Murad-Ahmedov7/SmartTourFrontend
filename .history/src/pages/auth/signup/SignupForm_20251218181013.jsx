...
export default function SignupForm() {
  ...
  const[allSignUpData,setAllSignUpData]=useState([])
  ...
  useEffect(()=>{
    const postData=async()=>{
      try{
       const res = await baseApi.post("auth/register",allSignUpData)
  ...
  const onSubmit = (data) => {
  try {
    const res = await baseApi.post("/api/auth/register", data);
